1. U can found the laragon cronical.dat config in this path (based on where u install laragon): 
		E:\laragon\bin\cronical


2. For Laravel 11, cronjob only working by define the job at:
		TheProjectRoot/routes/console.php:
		...
		TheProjectRoot/app/Jobs/AutoCloseExpiredWorksheetsJob.php:
			<?php
				namespace App\Jobs;
