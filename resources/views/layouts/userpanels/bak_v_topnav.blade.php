            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link AVATAR-1" id="dropdown-user"
                    ...
                    @php
                        ...
                        // Check if daftar_login_4get exists and has karyawan data
                        if (isset($authenticated_user_data['daftar_login_4get'])) {
                            if (isset($authenticated_user_data['daftar_login_4get']['karyawan']['na_karyawan'])) {
                                $accName = $authenticated_user_data['daftar_login_4get']['karyawan']['na_karyawan'];
                            } else {
                                $accName = $authenticated_user_data['daftar_login_4get']['username'] ?: 'No Name';
                            }
                        } elseif (isset($authenticated_user_data['na_karyawan'])) {
                            $accName = $authenticated_user_data['na_karyawan'];
                        }
                    ...
                    <div class="user-nav d-sm-flex">
                        ...
                        <span
                            class="user-status">{{ $authenticated_user_data ? ($authenticated_user_data->daftar_login_4get?->type ?: $authenticated_user_data->daftar_login->type ?: 'Illegal Access') : 'Illegal Access' }}</span>
                    </div>
