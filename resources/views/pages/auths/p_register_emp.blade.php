...
<head>
    ...
    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/theme/vuexy/app-assets/css/bootstrap.css') }}?v={{ time() }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/theme/vuexy/app-assets/css/bootstrap-extended.css') }}?v={{ time() }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/theme/vuexy/app-assets/css/colors.css') }}?v={{ time() }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/theme/vuexy/app-assets/css/components.css') }}?v={{ time() }}">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/theme/vuexy/app-assets/css/pages/page-auth.css') }}?v={{ time() }}">
    <link rel="stylesheet" type="text/css"
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/theme/vuexy/assets/css/style.css') }}?v={{ time() }}">
    <!-- END: Custom CSS-->
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="register-privacy-policy"
                                                data-toggle="modal" data-target="#modalPrivacyPolicy">I agree
                                                to<a {{-- href="javascript:void(0);" --}}>&nbsp;privacy policy &
                                                    terms</a></label>
                                        </div>
                                    </div>
