                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid"
                                    src="{{ asset('public/theme/vuexy/app-assets/images/pages/reset-password-v2-dark.svg') }}"
                                    alt="Reset V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Reset-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2 text-center">Please input your new password & confirm it.</p>
                                <form class="auth-login-form mt-2" action="{{ route('reset.do', ['token' => $token, 'email' => $email]) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                          ...
                                          value="{{ old('reset-password-new', $inputs['reset-password-new'] ?? '') }}" />
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                          ...
                                          value="{{ old('reset-password-confirm', $inputs['reset-password-confirm'] ?? '') }}" />
                                          <div class="input-group-append"><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span></div>
                                        </div>
                                      </div>
