                            ...
                            $('.lock-ws-cmd').on('click', function() {
                                ...
                                function setInfoText(response) {
                                    setTimeout(() => {
                                        ...
                                        if (infoText) {
                                            infoText.innerHTML =
                                                `Are you sure you want to <a class="text-warning">Lock the worksheet for ${response.projectID} with working date *${response.workingDate} that was executed by ${response.namaKaryawan}? Please confirm by filling "<a class="text-danger">FINISH-TIME</a>" and clicking "<a class="text-danger">LOCK</a>" below.`; // Update with your desired content
                                        } else {
                                            console.error(
                            ...
                            $('.unlock-ws-cmd').on('click', function() {
                                ...
                                function setInfoText(response) {
                                    setTimeout(() => {
                                        ...
                                        if (infoText2) {
                                            infoText2.innerHTML =
                                                `Are you sure you want to <a class="text-warning">Unlock the worksheet for ${response.projectID} with working date *${response.workingDate} that was executed by ${response.namaKaryawan}? Please confirm by clicking "<a class="text-danger">UNLOCK</a>" below.`; // Update with your desired content
                                        } else {
                                            console.error(
                                                "infoText element not found in the specified modal:",
                                                whichModal2);
