 <div class="modal fade text-left modal-success" id="delete_karyawanModal" tabindex="-1" role="dialog"
     ...
     <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body" style="max-height: 85vh; overflow-y: auto;">
                 <form class="row g-2 needs-validation mt-1" method="POST" action="{{ route('m.emp.del') }}" id="delete_karyawanModalFORM"
                     novalidate>
                     @csrf
                     ...
                     <input type="hidden" id="del_karyawan_id" name="del_karyawan_id" value="" />
