                 ...
                 <form class="row g-2 needs-validation mt-1" method="POST" action="{{ route('m.user.emp.edit') }}" id="edit_userModalFORM"
                     ...
                     <div class="col-12 col-sm-6">
                         <div class="form-group mb-0">
                             ...
                             <select class="select2 form-control form-control-lg" name="modalEditEmployee" id="modalEditEmployee" @disabled(true)>
                                {{-- GOT OPTIONS FROM JS --}}
                            </select>
                         </div>
                     </div>
                     ...
                     <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="select2 form-control form-control-lg" name="modalEditUserType" id="modalEditUserType">
                                ...
                                {{-- <option value="1" {{ $authenticated_user_data && $authenticated_user_data->daftar_login && $authenticated_user_data->daftar_login->type == 'Client' ? 'selected' : '' }}>
                                    Client
                                </option> --}}
                                <option value="2" {{ $authenticated_user_data && $authenticated_user_data->daftar_login && $authenticated_user_data->daftar_login->type == 'Superuser' ? 'selected' : '' }}>
                                    Superuser
                                </option>
                                <option value="3" {{ $authenticated_user_data && $authenticated_user_data->daftar_login && $authenticated_user_data->daftar_login->type == 'Supervisor' ? 'selected' : '' }}>
                                    Supervisor
                                </option>
                                <option value="4" {{ $authenticated_user_data && $authenticated_user_data->daftar_login && $authenticated_user_data->daftar_login->type == 'Engineer' ? 'selected' : '' }}>
                                    Engineer
                                </option>
                            </select>
                        </div>
